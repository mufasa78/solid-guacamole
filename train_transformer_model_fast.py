...
def main():
    ...
    for model_name, config in models_config.items():
        ...
        # Create data loaders
        # For transformer models, we need to handle the encodings differently
        train_dataset = [(train_encodings, torch.tensor(train_labels))]
        val_dataset = [(val_encodings, torch.tensor(val_labels))]
        test_dataset = [(test_encodings, torch.tensor(test_labels))]
